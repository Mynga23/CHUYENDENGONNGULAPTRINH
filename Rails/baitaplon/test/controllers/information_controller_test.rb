...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference("Information.count") do
      post information_index_url, params: { information: { email: @information.email, first_name: @information.first_name, lats_name: @information.lats_name, phone: @information.phone, twitter: @information.twitter } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { email: @information.email, first_name: @information.first_name, lats_name: @information.lats_name, phone: @information.phone, twitter: @information.twitter } }
